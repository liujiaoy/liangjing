/*
    说明： 1.适用于单行或多行表头，固定thead，若无thead，默认固定table第一行（须有th）
           2.fixedTableHead适用于整个窗口滚动
           3.fixedTableHead2适用于嵌套在页面中的表格，表格滚动，表格外层需包裹div
           4.fillHead固定顶部搜索栏，固定任意模块在页面顶部
...
例子：
    ...
    <%--固定搜索栏--%>
    <div class="fixedHead">里面是要固定的模块</div>
    <table id="gvList">要固定的表格</table>
